...
class MyFirebase():
    ...
    def criar_conta(self, email, senha):
        ...
        if requisicao.ok:
            ...
            req_id = requests.get("https://projetoapp-64657-default-rtdb.firebaseio.com/proximo_id_vendedor.json")
            id_vendedor = req_id.json()

            link = f"https://projetoapp-64657-default-rtdb.firebaseio.com/{local_id}.json"
            info_usuario = (f''
            ...
            requests.patch("https://projetoapp-64657-default-rtdb.firebaseio.com/.json", data=info_id_vendedor)
